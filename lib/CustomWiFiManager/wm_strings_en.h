...
"<form action='/param'   method='get'><button>Set clock parameters</button></form><br/>\n",//MENU_PARAM
...
const char HTTP_FORM_PARAM_HEAD[]  PROGMEM = "<hr>PARAMETER PETER<br/>";
...
const char S_brand[]              PROGMEM = "WorkClock by Magic";
